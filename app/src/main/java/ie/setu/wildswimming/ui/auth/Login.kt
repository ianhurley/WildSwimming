package ie.setu.wildswimming.ui.auth
...
import ie.setu.wildswimming.ui.home.Home
import ie.setu.wildswimming.databinding.LoginBinding
            ...
            registerForActivityResult(ActivityResultContracts.StartActivityForResult()) { result ->
                when(result.resultCode){
                    RESULT_OK -> {
                        ...
                        Timber.i("Wildswimming Google Result $result.data")
                    }
                    RESULT_CANCELED -> {
